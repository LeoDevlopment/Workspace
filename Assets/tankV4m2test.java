...
public class tankV4m2test<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "tankv4m2test"), "main");
	private final ModelPart body;
	private final ModelPart body_tank;
	...
	private final ModelPart body_tower;
	private final ModelPart gun;

	public tankV4m2test(ModelPart root) {
		this.body = root.getChild("body");
		this.body_tank = this.body.getChild("body_tank");
		this.body_trak = this.body.getChild("body_trak");
		this.trak = this.body.getChild("trak");
		this.dop_el = this.body.getChild("dop_el");
		this.gun2 = this.body.getChild("gun2");
		this.tower = root.getChild("tower");
		this.body_tower = this.tower.getChild("body_tower");
		this.gun = this.tower.getChild("gun");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body_tank = body.addOrReplaceChild("body_tank", CubeListBuilder.create().texOffs(0, 0).addBox(-19.0F, -9.0F, -1.0F, 32.0F, 1.0F, 64.0F, new CubeDeformation(0.0F))
		.texOffs(78, 411).addBox(12.0F, -10.0F, -1.0F, 1.0F, 1.0F, 38.0F, new CubeDeformation(0.0F))
		.texOffs(576, 172).addBox(12.0F, -23.7F, -13.4F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(582, 365).addBox(12.0F, -20.7F, -13.4F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(452, 471).addBox(12.0F, -24.0F, 37.0F, 1.0F, 15.0F, 26.0F, new CubeDeformation(0.0F))
		.texOffs(80, 569).addBox(12.0F, -38.0F, 37.0F, 1.0F, 14.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(126, 556).addBox(12.0F, -24.0F, 63.0F, 1.0F, 8.0F, 7.0F, new CubeDeformation(0.0F))
		.texOffs(578, 412).addBox(12.0F, -16.0F, 63.0F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(580, 552).addBox(12.0F, -16.0F, 64.0F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(582, 412).addBox(12.0F, -16.0F, 65.0F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(102, 584).addBox(12.0F, -16.0F, 66.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(584, 446).addBox(12.0F, -16.0F, 67.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(316, 585).addBox(12.0F, -16.0F, 68.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(586, 29).addBox(12.0F, -16.0F, 69.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(128, 287).addBox(-19.0F, -41.4407F, 2.157F, 32.0F, 2.0F, 35.0F, new CubeDeformation(0.0F))
		.texOffs(584, 80).addBox(12.0F, -35.4407F, 0.157F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(30, 586).addBox(12.0F, -36.4407F, 1.157F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(234, 433).addBox(12.0F, -39.4407F, 2.157F, 1.0F, 5.0F, 35.0F, new CubeDeformation(0.0F))
		.texOffs(478, 256).addBox(-19.0F, -23.7782F, 69.7782F, 32.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(276, 191).addBox(5.0F, -24.7782F, 45.7782F, 8.0F, 1.0F, 25.0F, new CubeDeformation(0.0F))
		.texOffs(240, 62).addBox(-11.0F, -24.7782F, 69.7782F, 16.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(554, 569).addBox(-11.0F, -36.7782F, 46.7782F, 1.0F, 13.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(174, 532).addBox(-11.0F, -37.2782F, 44.7782F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(574, 483).addBox(-11.0F, -37.5782F, 43.7782F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(218, 576).addBox(-11.0F, -37.8782F, 42.7782F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(262, 315).addBox(-11.0F, -38.0782F, 41.7782F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(580, 538).addBox(-11.0F, -38.3782F, 40.7782F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(582, 359).addBox(-11.0F, -38.6782F, 39.7782F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(76, 584).addBox(-11.0F, -38.9032F, 38.7782F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(266, 585).addBox(-11.0F, -39.1782F, 37.7782F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(12, 586).addBox(-11.0F, -39.2782F, 36.7782F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(558, 569).addBox(-11.0F, -37.0032F, 45.7782F, 1.0F, 13.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(482, 66).addBox(-11.0F, -24.7032F, 45.1782F, 1.0F, 1.0F, 24.0F, new CubeDeformation(0.0F))
		.texOffs(482, 91).addBox(4.0F, -24.7032F, 45.1782F, 1.0F, 1.0F, 24.0F, new CubeDeformation(0.0F))
		.texOffs(364, 572).addBox(-11.0F, -36.4782F, 47.7782F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(572, 438).addBox(-11.0F, -36.2782F, 48.7782F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(152, 571).addBox(-11.0F, -36.0782F, 49.7782F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(448, 573).addBox(-11.0F, -35.6782F, 50.7782F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(574, 53).addBox(-11.0F, -35.4782F, 51.7782F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(416, 574).addBox(-11.0F, -35.1782F, 52.7782F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(574, 266).addBox(-11.0F, -34.8782F, 53.7782F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(548, 575).addBox(-11.0F, -34.6782F, 54.7782F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(574, 570).addBox(-11.0F, -34.3782F, 55.7782F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(574, 424).addBox(-11.0F, -34.0782F, 56.7782F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(0, 575).addBox(-11.0F, -33.8782F, 57.7782F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(54, 576).addBox(-11.0F, -33.5782F, 58.7782F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(210, 576).addBox(-11.0F, -33.2782F, 59.7782F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(576, 210).addBox(-11.0F, -33.0032F, 60.7782F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(214, 576).addBox(-11.0F, -32.7532F, 61.7782F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(346, 577).addBox(-11.0F, -32.4532F, 62.7782F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(350, 577).addBox(-11.0F, -32.2032F, 63.7782F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(578, 353).addBox(-11.0F, -31.2032F, 64.7782F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(394, 582).addBox(-11.0F, -29.2032F, 65.7782F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(584, 438).addBox(-11.0F, -27.2032F, 66.7782F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(22, 586).addBox(-11.0F, -25.2032F, 67.7782F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(586, 27).addBox(4.0F, -25.2032F, 67.7782F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(584, 442).addBox(4.0F, -27.2032F, 66.7782F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(402, 582).addBox(4.0F, -29.2032F, 65.7782F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(578, 361).addBox(4.0F, -31.2032F, 64.7782F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(578, 37).addBox(4.0F, -32.2032F, 63.7782F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(578, 28).addBox(4.0F, -32.4532F, 62.7782F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(390, 576).addBox(4.0F, -32.7532F, 61.7782F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(576, 252).addBox(4.0F, -33.0032F, 60.7782F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(226, 576).addBox(4.0F, -33.2782F, 59.7782F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(58, 576).addBox(4.0F, -33.5782F, 58.7782F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(8, 575).addBox(4.0F, -33.8782F, 57.7782F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(514, 574).addBox(4.0F, -34.0782F, 56.7782F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(4, 575).addBox(4.0F, -34.3782F, 55.7782F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(50, 576).addBox(4.0F, -34.6782F, 54.7782F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(300, 574).addBox(4.0F, -34.8782F, 53.7782F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(420, 574).addBox(4.0F, -35.1782F, 52.7782F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(296, 574).addBox(4.0F, -35.4782F, 51.7782F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(452, 573).addBox(4.0F, -35.6782F, 50.7782F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(272, 571).addBox(4.0F, -36.0782F, 49.7782F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(572, 546).addBox(4.0F, -36.2782F, 48.7782F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(572, 470).addBox(4.0F, -36.4782F, 47.7782F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(170, 570).addBox(4.0F, -36.7782F, 46.7782F, 1.0F, 13.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(76, 570).addBox(4.0F, -37.0032F, 45.7782F, 1.0F, 13.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(26, 586).addBox(4.0F, -39.2782F, 36.7782F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(312, 585).addBox(4.0F, -39.1782F, 37.7782F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(80, 584).addBox(4.0F, -38.9032F, 38.7782F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(398, 582).addBox(4.0F, -38.6782F, 39.7782F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(580, 545).addBox(4.0F, -38.3782F, 40.7782F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(532, 110).addBox(4.0F, -38.0782F, 41.7782F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(222, 576).addBox(4.0F, -37.8782F, 42.7782F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(574, 494).addBox(4.0F, -37.5782F, 43.7782F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(358, 546).addBox(4.0F, -37.2782F, 44.7782F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(334, 477).addBox(-19.0F, -24.7782F, 45.7782F, 8.0F, 1.0F, 25.0F, new CubeDeformation(0.0F))
		.texOffs(480, 147).addBox(-19.0F, -24.1772F, -14.1064F, 32.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(142, 556).addBox(-19.0F, -24.0F, 63.0F, 1.0F, 8.0F, 7.0F, new CubeDeformation(0.0F))
		.texOffs(586, 33).addBox(-19.0F, -16.0F, 69.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(328, 585).addBox(-19.0F, -16.0F, 68.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(584, 450).addBox(-19.0F, -16.0F, 67.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(152, 584).addBox(-19.0F, -16.0F, 66.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(582, 422).addBox(-19.0F, -16.0F, 65.0F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(532, 581).addBox(-19.0F, -16.0F, 64.0F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(578, 420).addBox(-19.0F, -16.0F, 63.0F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(218, 473).addBox(-19.0F, -24.0F, 37.0F, 1.0F, 15.0F, 26.0F, new CubeDeformation(0.0F))
		.texOffs(194, 569).addBox(-19.0F, -38.0F, 37.0F, 1.0F, 14.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(478, 166).addBox(-18.0F, -38.0F, 37.0F, 30.0F, 29.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(306, 433).addBox(-19.0F, -39.4407F, 2.157F, 1.0F, 5.0F, 35.0F, new CubeDeformation(0.0F))
		.texOffs(420, 362).addBox(-19.0F, -10.0F, -1.0F, 1.0F, 1.0F, 38.0F, new CubeDeformation(0.0F))
		.texOffs(582, 418).addBox(-19.0F, -20.7F, -13.4F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(394, 576).addBox(-19.0F, -23.7F, -13.4F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(584, 134).addBox(-19.0F, -35.4407F, 0.157F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(586, 31).addBox(-19.0F, -36.4407F, 1.157F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(408, 560).addBox(1.0F, -38.3F, -12.9F, 7.0F, 13.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(180, 518).addBox(1.0F, -38.3F, -11.9F, 7.0F, 1.0F, 12.0F, new CubeDeformation(0.0F))
		.texOffs(24, 555).addBox(8.0F, -38.3F, -7.9F, 4.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
		.texOffs(48, 555).addBox(-3.0F, -38.3F, -7.9F, 4.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
		.texOffs(242, 545).addBox(-3.0F, -38.3F, -8.9F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(582, 246).addBox(-2.0F, -38.3F, -9.9F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(584, 512).addBox(-1.0F, -38.3F, -10.9F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(92, 586).addBox(0.0F, -38.3F, -11.9F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(574, 512).addBox(8.0F, -38.3F, -8.9F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(582, 275).addBox(8.0F, -38.3F, -9.9F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(584, 526).addBox(8.0F, -38.3F, -10.9F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(586, 100).addBox(8.0F, -38.3F, -11.9F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, 1.3F, -29.1F));

		PartDefinition cube_r1 = body_tank.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(468, 561).addBox(-4.0F, -37.0F, -1.0F, 7.0F, 13.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(10.1213F, -1.3F, -9.3645F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r2 = body_tank.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 561).addBox(-3.0F, -37.0F, -1.0F, 7.0F, 13.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.1213F, -1.3F, -9.3645F, 0.0F, 0.7854F, 0.0F));

		PartDefinition cube_r3 = body_tank.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(556, 56).addBox(4.0F, -37.0F, -52.0F, 8.0F, 13.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-39.0502F, -1.3F, -11.9502F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r4 = body_tank.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(556, 42).addBox(4.0F, -37.0F, -36.0F, 8.0F, 13.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-38.9498F, -1.3F, -11.9502F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r5 = body_tank.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(398, 271).addBox(-19.0F, -11.0F, 0.0F, 32.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.7071F, 62.2929F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r6 = body_tank.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(286, 565).addBox(12.0F, -30.2F, 11.0F, 1.0F, 20.0F, 1.0F, new CubeDeformation(0.0F))
		...
		.texOffs(370, 530).addBox(12.0F, -32.0F, 9.0F, 3.0F, 23.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-31.0F, -24.1772F, -26.8344F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r7 = body_tank.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(514, 554).addBox(12.0F, -24.0F, 10.0F, 1.0F, 16.0F, 4.0F, new CubeDeformation(0.0F))
		...
		.texOffs(334, 39).addBox(12.0F, -24.0F, 9.0F, 32.0F, 16.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-31.0F, 3.961F, 0.391F, 0.9599F, 0.0F, 0.0F));

		PartDefinition cube_r8 = body_tank.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(584, 387).addBox(12.0F, 7.0043F, -5.4798F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		...
		.texOffs(498, 387).addBox(36.0F, 0.0043F, -17.9798F, 8.0F, 1.0F, 18.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-31.0F, -24.7782F, 46.7782F, -1.0036F, 0.0F, 0.0F));

		PartDefinition cube_r9 = body_tank.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(430, 30).addBox(0.0F, -0.9957F, -0.9798F, 10.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
		...
		.texOffs(452, 440).addBox(10.0F, -0.9957F, -0.9798F, 3.0F, 1.0F, 30.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.0F, -39.2361F, 37.4958F, -0.2618F, 0.0F, 0.0F));

		PartDefinition cube_r10 = body_tank.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(504, 576).addBox(-35.0F, -9.0F, -1.0F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(442, 576).addBox(-50.0F, -9.0F, -1.0F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(518, 155).addBox(-50.0F, -9.0F, 0.0F, 16.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(39.0F, -24.3926F, 69.4188F, 0.5236F, 0.0F, 0.0F));

		PartDefinition body_trak = body.addOrReplaceChild("body_trak", CubeListBuilder.create().texOffs(148, 65).addBox(25.8F, -15.9012F, -23.3878F, 1.0F, 14.0F, 63.0F, new CubeDeformation(0.0F))
		...
		.texOffs(584, 206).addBox(-17.0F, -14.1973F, 42.4332F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r11 = body_trak.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(578, 55).addBox(-9.0F, -25.975F, -1.975F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r12 = body_trak.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(564, 210).addBox(-8.0F, -10.0F, -5.875F, 5.0F, 12.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r13 = body_trak.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(424, 565).addBox(-9.0F, -9.0F, -2.875F, 1.0F, 10.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r14 = body_trak.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(378, 503).addBox(-9.0F, -45.0F, -1.275F, 1.0F, 44.0F, 3.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r15 = body_trak.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(394, 323).addBox(-9.0F, -20.0F, -1.125F, 1.0F, 20.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r16 = body_trak.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(368, 585).addBox(-9.0F, -5.0F, 3.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r17 = body_trak.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(364, 585).addBox(-9.0F, -5.0F, 3.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r18 = body_trak.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(336, 585).addBox(-9.0F, -3.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r19 = body_trak.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(580, 297).addBox(-9.0F, -3.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r20 = body_trak.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(582, 518).addBox(-9.0F, -18.0F, 5.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r21 = body_trak.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(582, 488).addBox(-9.0F, -7.0F, -2.875F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r22 = body_trak.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(366, 530).addBox(-9.0F, -45.0F, -1.275F, 1.0F, 41.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r23 = body_trak.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(316, 565).addBox(-9.0F, -20.0F, 1.875F, 1.0F, 19.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r24 = body_trak.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(260, 562).addBox(-9.0F, -26.0F, -3.975F, 1.0F, 22.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r25 = body_trak.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(130, 480).addBox(-8.0F, -7.0F, -0.35F, 10.0F, 16.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r26 = body_trak.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(562, 514).addBox(-8.0F, -5.0F, -0.35F, 9.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r27 = body_trak.addOrReplaceChild("cube_r27", CubeListBuilder.create().texOffs(556, 79).addBox(-8.0F, -27.0F, -4.35F, 10.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r28 = body_trak.addOrReplaceChild("cube_r28", CubeListBuilder.create().texOffs(502, 532).addBox(-8.0F, -21.0F, -0.35F, 10.0F, 21.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition trak = body.addOrReplaceChild("trak", CubeListBuilder.create().texOffs(550, 484).addBox(17.0F, -24.0F, -47.0F, 10.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
		...
		.texOffs(0, 327).addBox(-27.0F, -39.5564F, -31.4437F, 10.0F, 2.0F, 40.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r29 = trak.addOrReplaceChild("cube_r29", CubeListBuilder.create().texOffs(512, 0).addBox(-9.0F, -28.0F, -1.0F, 10.0F, 28.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r30 = trak.addOrReplaceChild("cube_r30", CubeListBuilder.create().texOffs(532, 60).addBox(-9.0F, -22.0F, -1.0F, 10.0F, 22.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r31 = trak.addOrReplaceChild("cube_r31", CubeListBuilder.create().texOffs(538, 339).addBox(-9.0F, -12.0F, -1.0F, 10.0F, 12.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r32 = trak.addOrReplaceChild("cube_r32", CubeListBuilder.create().texOffs(24, 486).addBox(-9.0F, -46.0F, -1.0F, 10.0F, 46.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition dop_el = body.addOrReplaceChild("dop_el", CubeListBuilder.create().texOffs(536, 293).addBox(-10.5F, -29.7F, -39.2F, 6.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
		...
		.texOffs(140, 586).addBox(26.8F, -32.0F, -3.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition gun2 = body.addOrReplaceChild("gun2", CubeListBuilder.create().texOffs(564, 285).addBox(-1.0F, -26.0F, -53.0F, 3.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		...
		.texOffs(584, 507).addBox(-2.3F, -22.3F, -51.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(7.0F, -8.0F, 7.0F));

		PartDefinition cube_r56 = gun2.addOrReplaceChild("cube_r56", CubeListBuilder.create().texOffs(584, 381).addBox(0.0F, -1.0F, -55.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r57 = gun2.addOrReplaceChild("cube_r57", CubeListBuilder.create().texOffs(464, 119).addBox(0.0F, -1.0F, -51.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		...
		PartDefinition tower = partdefinition.addOrReplaceChild("tower", CubeListBuilder.create(), PartPose.offset(0.0F, -16.0F, -9.0F));

		PartDefinition body_tower = tower.addOrReplaceChild("body_tower", CubeListBuilder.create().texOffs(282, 526).addBox(-4.0F, -11.0F, -1.0F, 16.0F, 11.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(400, 166).addBox(-7.0F, -11.0F, 30.0F, 22.0F, 10.0F, 9.0F, new CubeDeformation(0.0F))
		.texOffs(192, 62).addBox(-7.1568F, -12.0F, 29.3793F, 22.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(334, 56).addBox(-7.1568F, -1.0F, 29.3793F, 22.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(140, 532).addBox(-3.5355F, -11.0F, 40.5355F, 15.0F, 10.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(524, 30).addBox(-4.5355F, -11.0F, 38.5355F, 17.0F, 10.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(334, 59).addBox(-7.1568F, -1.0F, 29.3793F, 22.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.7381F, 0.0F, -16.2215F));

		PartDefinition cube_r58 = body_tower.addOrReplaceChild("cube_r58", CubeListBuilder.create().texOffs(464, 182).addBox(-7.0F, -10.0F, -2.0F, 6.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(580, 8).addBox(-5.0F, -4.0F, -2.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(552, 150).addBox(-8.0F, -12.0F, -1.0F, 8.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-11.7929F, 0.0F, 25.0153F, 0.0F, 2.3562F, 0.0F));

		PartDefinition cube_r59 = body_tower.addOrReplaceChild("cube_r59", CubeListBuilder.create().texOffs(336, 217).addBox(0.0F, -1.0F, 26.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		.texOffs(306, 217).addBox(0.0F, -1.0F, 19.5F, 14.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.0238F, -11.0038F, 13.8096F, 1.5708F, 1.4835F, 1.5708F));

		PartDefinition cube_r60 = body_tower.addOrReplaceChild("cube_r60", CubeListBuilder.create().texOffs(584, 505).addBox(-2.0F, -1.0F, 26.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		.texOffs(498, 425).addBox(-14.0F, -1.0F, 6.0F, 14.0F, 1.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(16.5F, -11.0038F, 13.8096F, 1.5708F, -1.4835F, -1.5708F));

		PartDefinition cube_r61 = body_tower.addOrReplaceChild("cube_r61", CubeListBuilder.create().texOffs(574, 510).addBox(8.0F, -12.0F, -17.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.4762F, 11.0F, 21.7224F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r62 = body_tower.addOrReplaceChild("cube_r62", CubeListBuilder.create().texOffs(536, 530).addBox(8.0F, -12.0F, -17.0F, 7.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.4762F, 11.0F, 21.7224F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r63 = body_tower.addOrReplaceChild("cube_r63", CubeListBuilder.create().texOffs(566, 106).addBox(8.0F, -12.0F, -17.0F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(10.4762F, 11.0F, 21.7224F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r64 = body_tower.addOrReplaceChild("cube_r64", CubeListBuilder.create().texOffs(562, 526).addBox(8.0F, -12.0F, -17.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(11.4762F, 11.0F, 21.7224F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r65 = body_tower.addOrReplaceChild("cube_r65", CubeListBuilder.create().texOffs(234, 431).addBox(8.0F, -12.0F, -17.0F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(12.4762F, 11.0F, 21.7224F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r66 = body_tower.addOrReplaceChild("cube_r66", CubeListBuilder.create().texOffs(586, 57).addBox(8.0F, -12.0F, -17.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.4762F, 11.0F, 21.7224F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r67 = body_tower.addOrReplaceChild("cube_r67", CubeListBuilder.create().texOffs(580, 130).addBox(8.0F, -12.0F, -17.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.4762F, 11.0F, 21.7224F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r68 = body_tower.addOrReplaceChild("cube_r68", CubeListBuilder.create().texOffs(586, 55).addBox(-9.0F, -12.0F, -17.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 11.0F, 21.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r69 = body_tower.addOrReplaceChild("cube_r69", CubeListBuilder.create().texOffs(578, 104).addBox(-11.0F, -12.0F, -17.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 11.0F, 21.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r70 = body_tower.addOrReplaceChild("cube_r70", CubeListBuilder.create().texOffs(574, 456).addBox(-13.0F, -12.0F, -17.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, 11.0F, 21.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r71 = body_tower.addOrReplaceChild("cube_r71", CubeListBuilder.create().texOffs(426, 522).addBox(-15.0F, -12.0F, -17.0F, 7.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, 11.0F, 21.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r72 = body_tower.addOrReplaceChild("cube_r72", CubeListBuilder.create().texOffs(564, 225).addBox(-16.0F, -12.0F, -17.0F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.5F, 11.0F, 21.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r73 = body_tower.addOrReplaceChild("cube_r73", CubeListBuilder.create().texOffs(562, 351).addBox(-18.0F, -12.0F, -17.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, 11.0F, 21.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r74 = body_tower.addOrReplaceChild("cube_r74", CubeListBuilder.create().texOffs(298, 391).addBox(-20.0F, -12.0F, -17.0F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5F, 11.0F, 21.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r75 = body_tower.addOrReplaceChild("cube_r75", CubeListBuilder.create().texOffs(482, 344).addBox(-21.0F, -12.0F, -31.0F, 13.0F, 1.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-19.5F, 11.0F, 21.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r76 = body_tower.addOrReplaceChild("cube_r76", CubeListBuilder.create().texOffs(430, 0).addBox(-22.0F, -12.0F, -28.0F, 12.0F, 1.0F, 29.0F, new CubeDeformation(0.0F))
		.texOffs(74, 450).addBox(-21.0F, -23.0F, -28.0F, 10.0F, 1.0F, 29.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.5F, 11.0F, 35.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r77 = body_tower.addOrReplaceChild("cube_r77", CubeListBuilder.create().texOffs(586, 185).addBox(14.0F, -12.0F, -24.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(184, 586).addBox(14.0F, -23.0F, -24.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(40.4762F, 11.0F, 40.7224F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r78 = body_tower.addOrReplaceChild("cube_r78", CubeListBuilder.create().texOffs(584, 550).addBox(13.0F, -12.0F, -24.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(584, 548).addBox(13.0F, -23.0F, -24.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(39.4762F, 11.0F, 40.7224F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r79 = body_tower.addOrReplaceChild("cube_r79", CubeListBuilder.create().texOffs(328, 583).addBox(12.0F, -12.0F, -24.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(320, 583).addBox(12.0F, -23.0F, -24.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(38.4762F, 11.0F, 40.7224F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r80 = body_tower.addOrReplaceChild("cube_r80", CubeListBuilder.create().texOffs(586, 187).addBox(-15.0F, -12.0F, -24.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(174, 586).addBox(-15.0F, -23.0F, -24.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-32.5F, 11.0F, 40.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r81 = body_tower.addOrReplaceChild("cube_r81", CubeListBuilder.create().texOffs(584, 552).addBox(-15.0F, -12.0F, -24.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(584, 546).addBox(-15.0F, -23.0F, -24.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-31.5F, 11.0F, 40.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r82 = body_tower.addOrReplaceChild("cube_r82", CubeListBuilder.create().texOffs(522, 583).addBox(-15.0F, -12.0F, -24.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(582, 464).addBox(-15.0F, -23.0F, -24.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-30.5F, 11.0F, 40.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r83 = body_tower.addOrReplaceChild("cube_r83", CubeListBuilder.create().texOffs(130, 498).addBox(-15.0F, -12.0F, -24.0F, 4.0F, 1.0F, 21.0F, new CubeDeformation(0.0F))
		.texOffs(482, 322).addBox(-15.0F, -23.0F, -24.0F, 4.0F, 1.0F, 21.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.5F, 11.0F, 40.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r84 = body_tower.addOrReplaceChild("cube_r84", CubeListBuilder.create().texOffs(532, 313).addBox(-18.0F, -12.0F, -29.0F, 7.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-28.5F, -1.0F, 34.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r85 = body_tower.addOrReplaceChild("cube_r85", CubeListBuilder.create().texOffs(584, 334).addBox(-13.0F, -13.0F, -28.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-29.5F, -0.5F, 28.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r86 = body_tower.addOrReplaceChild("cube_r86", CubeListBuilder.create().texOffs(584, 337).addBox(-13.0F, -13.0F, -28.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-34.5F, -0.5F, 28.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r87 = body_tower.addOrReplaceChild("cube_r87", CubeListBuilder.create().texOffs(578, 77).addBox(0.6208F, -0.7334F, 2.1303F, 1.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(578, 70).addBox(-2.3792F, -0.7334F, 2.1303F, 1.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(564, 22).addBox(-2.8792F, -1.7334F, 1.6303F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(23.5F, -10.0F, 12.693F, 1.8326F, -0.7854F, -1.5708F));

		PartDefinition cube_r88 = body_tower.addOrReplaceChild("cube_r88", CubeListBuilder.create().texOffs(576, 476).addBox(-11.5F, -14.0F, -28.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
		...
		.texOffs(576, 444).addBox(-14.0F, -14.0F, -28.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.5F, -13.0F, 25.693F, 1.5708F, -0.7854F, -1.5708F));

		PartDefinition cube_r89 = body_tower.addOrReplaceChild("cube_r89", CubeListBuilder.create().texOffs(218, 569).addBox(-13.0F, -12.0F, -32.0F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-19.5F, -13.0F, 25.693F, 1.5708F, -0.7854F, -1.5708F));

		PartDefinition cube_r90 = body_tower.addOrReplaceChild("cube_r90", CubeListBuilder.create().texOffs(578, 498).addBox(-13.0F, -12.0F, -31.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(522, 585).addBox(-13.0F, -12.0F, -28.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-19.5F, -1.0F, 20.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r91 = body_tower.addOrReplaceChild("cube_r91", CubeListBuilder.create().texOffs(518, 585).addBox(-13.0F, -13.0F, -28.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-15.5F, 0.0F, 20.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r92 = body_tower.addOrReplaceChild("cube_r92", CubeListBuilder.create().texOffs(290, 584).addBox(-13.0F, -13.0F, -28.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-17.5F, -0.5F, 28.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r93 = body_tower.addOrReplaceChild("cube_r93", CubeListBuilder.create().texOffs(272, 584).addBox(-13.0F, -13.0F, -28.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-12.5F, -0.5F, 28.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r94 = body_tower.addOrReplaceChild("cube_r94", CubeListBuilder.create().texOffs(532, 302).addBox(-18.0F, -12.0F, -28.0F, 7.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-10.5F, -1.0F, 34.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r95 = body_tower.addOrReplaceChild("cube_r95", CubeListBuilder.create().texOffs(478, 226).addBox(-12.0F, -12.0F, -28.0F, 1.0F, 1.0F, 29.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.5F, 0.0F, 36.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r96 = body_tower.addOrReplaceChild("cube_r96", CubeListBuilder.create().texOffs(478, 196).addBox(-12.0F, -12.0F, -28.0F, 1.0F, 1.0F, 29.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.5F, 0.0F, 25.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r97 = body_tower.addOrReplaceChild("cube_r97", CubeListBuilder.create().texOffs(358, 473).addBox(4.0F, -1.0F, -1.0F, 8.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.9394F, -11.4981F, 32.6629F, 0.0F, 2.3562F, 0.0F));

		PartDefinition cube_r98 = body_tower.addOrReplaceChild("cube_r98", CubeListBuilder.create().texOffs(80, 408).addBox(-12.0F, -1.0F, -1.0F, 8.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(10.9156F, -11.4981F, 32.6629F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r99 = body_tower.addOrReplaceChild("cube_r99", CubeListBuilder.create().texOffs(438, 122).addBox(-12.0F, -1.0F, -1.0F, 11.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(19.108F, -11.4981F, 25.8847F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r100 = body_tower.addOrReplaceChild("cube_r100", CubeListBuilder.create().texOffs(272, 504).addBox(-3.0F, -1.0F, -20.0F, 2.0F, 1.0F, 21.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.4749F, -11.4981F, 31.5415F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r101 = body_tower.addOrReplaceChild("cube_r101", CubeListBuilder.create().texOffs(438, 119).addBox(-12.0F, -1.0F, -1.0F, 11.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-11.1318F, -11.4981F, 25.8847F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r102 = body_tower.addOrReplaceChild("cube_r102", CubeListBuilder.create().texOffs(438, 188).addBox(-12.0F, -10.0F, 6.0F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5208F, -5.8787F, 13.7224F, 0.0F, -1.5708F, -0.7854F));

		PartDefinition cube_r103 = body_tower.addOrReplaceChild("cube_r103", CubeListBuilder.create().texOffs(404, 119).addBox(-12.0F, -8.0F, 0.0F, 12.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.7929F, -0.7071F, 13.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r104 = body_tower.addOrReplaceChild("cube_r104", CubeListBuilder.create().texOffs(582, 348).addBox(-12.0F, -5.0F, 6.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5F, 6.3137F, 7.3793F, -1.5708F, -0.7854F, 1.5708F));

		PartDefinition cube_r105 = body_tower.addOrReplaceChild("cube_r105", CubeListBuilder.create().texOffs(586, 102).addBox(-11.0F, -5.0F, 6.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(120, 583).addBox(-12.0F, -8.0F, 6.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(448, 539).addBox(-10.0F, -8.0F, 2.0F, 9.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5F, 0.0F, 13.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r106 = body_tower.addOrReplaceChild("cube_r106", CubeListBuilder.create().texOffs(130, 583).addBox(-15.0F, -5.0F, 2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, -5.0F, 17.7224F, 0.0F, -1.5708F, -0.7854F));

		PartDefinition cube_r107 = body_tower.addOrReplaceChild("cube_r107", CubeListBuilder.create().texOffs(536, 265).addBox(-12.0F, -12.0F, -1.0F, 12.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-11.5F, 0.0F, 25.7224F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r108 = body_tower.addOrReplaceChild("cube_r108", CubeListBuilder.create().texOffs(260, 390).addBox(-17.0F, -1.0F, -1.0F, 17.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(19.6776F, -11.0038F, 14.2979F, 0.1498F, -1.0406F, -0.1732F));

		PartDefinition cube_r109 = body_tower.addOrReplaceChild("cube_r109", CubeListBuilder.create().texOffs(438, 185).addBox(1.0F, -1.0F, -1.0F, 11.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(518, 459).addBox(-5.0F, 0.0F, -1.0F, 17.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(13.634F, -10.0F, 3.8301F, 0.0F, -1.0472F, 0.0F));

		PartDefinition cube_r110 = body_tower.addOrReplaceChild("cube_r110", CubeListBuilder.create().texOffs(400, 188).addBox(-17.0F, -1.5F, -0.6F, 17.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(19.6538F, -11.0038F, 14.2979F, 0.1498F, -1.0406F, -0.1732F));

		PartDefinition cube_r111 = body_tower.addOrReplaceChild("cube_r111", CubeListBuilder.create().texOffs(400, 185).addBox(0.0F, -1.5F, -0.6F, 17.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(260, 387).addBox(0.0F, -1.0F, -1.0F, 17.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-11.6776F, -11.0038F, 14.2979F, 0.1498F, 1.0406F, 0.1732F));

		PartDefinition cube_r112 = body_tower.addOrReplaceChild("cube_r112", CubeListBuilder.create().texOffs(234, 428).addBox(-12.0F, -1.0F, -1.0F, 11.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(140, 520).addBox(-12.0F, 0.0F, -1.0F, 17.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.634F, -10.0F, 3.8301F, 0.0F, 1.0472F, 0.0F));

		PartDefinition cube_r113 = body_tower.addOrReplaceChild("cube_r113", CubeListBuilder.create().texOffs(564, 110).addBox(-5.0F, -10.0F, -1.0F, 5.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.2929F, -1.0F, 38.2929F, 0.0F, 2.3562F, 0.0F));

		PartDefinition cube_r114 = body_tower.addOrReplaceChild("cube_r114", CubeListBuilder.create().texOffs(50, 564).addBox(0.0F, -10.0F, -1.0F, 5.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(14.2929F, -1.0F, 38.2929F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r115 = body_tower.addOrReplaceChild("cube_r115", CubeListBuilder.create().texOffs(106, 552).addBox(0.0F, -12.0F, -1.0F, 8.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(19.7929F, 0.0F, 25.0153F, 0.0F, -2.3562F, 0.0F));

		PartDefinition cube_r116 = body_tower.addOrReplaceChild("cube_r116", CubeListBuilder.create().texOffs(536, 124).addBox(0.0F, -12.0F, -1.0F, 12.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(19.5F, 0.0F, 25.7224F, 0.0F, 1.5708F, 0.0F));

		PartDefinition gun = tower.addOrReplaceChild("gun", CubeListBuilder.create().texOffs(480, 155).addBox(-8.0F, -50.0F, -28.0F, 17.0F, 9.0F, 2.0F, new CubeDeformation(0.0F))
		...
		.texOffs(536, 143).addBox(2.9F, -46.5F, -28.5F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 40.0F, 9.0F));

		PartDefinition cube_r117 = gun.addOrReplaceChild("cube_r117", CubeListBuilder.create().texOffs(0, 534).addBox(-1.0F, -3.5F, -12.0F, 2.0F, 3.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.8439F, -45.5947F, -27.5F, 0.0F, 0.0F, -0.48F));

		PartDefinition cube_r118 = gun.addOrReplaceChild("cube_r118", CubeListBuilder.create().texOffs(536, 0).addBox(-1.0F, 0.5F, -12.0F, 2.0F, 3.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.8439F, -45.4053F, -27.5F, 0.0F, 0.0F, 0.48F));

		PartDefinition cube_r119 = gun.addOrReplaceChild("cube_r119", CubeListBuilder.create().texOffs(524, 532).addBox(-1.0F, 0.5F, -12.0F, 2.0F, 3.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.8439F, -45.4053F, -27.5F, 0.0F, 0.0F, -0.48F));

		PartDefinition cube_r120 = gun.addOrReplaceChild("cube_r120", CubeListBuilder.create().texOffs(532, 324).addBox(-1.0F, -3.5F, -12.0F, 2.0F, 3.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.8439F, -45.5947F, -27.5F, 0.0F, 0.0F, 0.48F));

		PartDefinition cube_r121 = gun.addOrReplaceChild("cube_r121", CubeListBuilder.create().texOffs(584, 369).addBox(1.0F, -1.0F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r122 = gun.addOrReplaceChild("cube_r122", CubeListBuilder.create().texOffs(584, 350).addBox(1.0F, -3.0F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r123 = gun.addOrReplaceChild("cube_r123", CubeListBuilder.create().texOffs(96, 583).addBox(1.0F, -1.0F, -40.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
